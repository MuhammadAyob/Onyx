       ...
       //Initialize db context
        ...
        private async Task SendAccountDetailsEmail(string emailID, string name, string surname, string password)
        {
            ...
            var message = "Dear" + " " + name + " " + surname
                ...
                + "<br>For further assistance or enquiries, please contact us at info@darussalaamcenter.co.za";
        ...
        private async Task SendEmailReactivated(string emailID)
        {
            ...
            var message = "Dear Onyx System User,"
                ...
                + "<br>"
                + "<br> For further assistance, please contact us at info@darussalaamcenter.co.za" +
